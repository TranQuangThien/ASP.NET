<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="shop_gird.aspx.cs" Inherits="Thuong_Mai_Dien_Tu.shop_gird" %>

<asp:Content ID="Content13" ContentPlaceHolderID="shop_gird" runat="server">
							...
							<div class="product-shooting-area">
								<div class="product-shooting-bar">
									...
									<div class="view-systeam">
										...
										<ul>
											<li class="active"><a href="shop-gird.aspx"><i class="fa fa-th-large"></i></a><br />Grid</li>
											<li><a href="shop-list.aspx"><i class="fa fa-th-list"></i></a><br />List</li>
										</ul>
									</div>
									<!-- VIEW-SYSTEAM END -->
								</div>
