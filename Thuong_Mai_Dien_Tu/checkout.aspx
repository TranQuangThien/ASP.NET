<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="checkout.aspx.cs" Inherits="Thuong_Mai_Dien_Tu.checkout1" %>

<asp:Content ID="Content17" ContentPlaceHolderID="checkout" runat="server">
						...
						<div class="shoping-cart-menu">
							<ul class="step">
								...
								<li class="step-todo four step-done">
									<span><a href="checkout_shipping.aspx">04. Shipping</a></span>
								</li>
